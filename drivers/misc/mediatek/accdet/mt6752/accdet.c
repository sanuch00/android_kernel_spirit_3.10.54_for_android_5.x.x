...
{
	/* LGE_CHANGE_S: [2015-01-07] jeongjoo.lee@lge.com */
	/* Comment: Change the variable position due to duplicate declarations. */
	int loop_count = 0;
	/* LGE_CHANGE_E: [2015-01-07] jeongjoo.lee@lge.com */
#ifdef ACCDET_EINT_IRQ
	int irq_temp = 0;
	          ...
	          switch (keycode)
				...
				case UP_KEY:
					...
					ACCDET_DEBUG("[accdet]KEY_VOLUMEUP %d\n",flag);
		   	        break;
                /* LGE_CHANGE_S: [2014-10-07] hyunsoo.yoon@lge.com */
                /* Comment: add KEY_MEDIA for MD_KEY */
				case MD_KEY:
					...
					ACCDET_DEBUG("[accdet]KEY_MEDIA %d\n",flag);
		   	        break;
				default:
                    printk("Wrong Key event keycode=%d\n", keycode);
                    break;
                /* LGE_CHANGE_E: [2014-10-07] hyunsoo.yoon@lge.com */
                }
//	}
...
/* LGE CHANGE 2014-05-09 Hyeonsang85.park@lge.com register earjack to input device - start*/
        ...
        // [LGE_BSP_COMMON] CHANGE_E 2014-03-25 seungsoo.jang@lge.com The initial setting
        else
        {
...
/* LGE CHANGE 2014-05-09 Hyeonsang85.park@lge.com earjack input device for minios-2nd - start */
    __set_bit(EV_SW, kpd_accdet_dev->evbit);
    __set_bit(EV_SYN, kpd_accdet_dev->evbit);
/* LGE CHANGE 2014-05-09 Hyeonsang85.park@lge.com earjack input device for minios-2nd - end */
...
/* LGE CHANGE 2014-05-09 Hyeonsang85.park@lge.com register earjack to input device - end*/
	...
	{	
		...
		accdet_init();   
// [LGE_BSP_COMMON] CHANGE_S 2014-04-19 seungsoo.jang@lge.com : Plug in earjack and Booting, don't r
// ecognize earjack uncommonly.
