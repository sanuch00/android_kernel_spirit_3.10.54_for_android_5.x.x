...
//#define SW_CALIBRATION	// use hardware fast calibration
#else	// vendor's original
...
#ifdef CONFIG_MACH_LGE	/* LGE_CHANGE_S 140220 : Bandwidth setting as fast as polling rate */
...
#else	// this code uses misc2 interface, it might be changed to use ftm interface
...
#endif	/* LGE_CHANGE_S 140220 : Bandwidth setting as fast as polling rate */
