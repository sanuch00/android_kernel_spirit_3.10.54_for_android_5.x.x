...
#if 1  /* LGE_BSP_COMMON LGE_CHANGE_S 141105 jongwoo82.lee : HW revision check */
extern int dsi_hw_rev;
#include <mach/board_lge.h>
#endif  /* LGE_BSP_COMMON LGE_CHANGE_E 141105 jongwoo82.lee : HW revision check */
