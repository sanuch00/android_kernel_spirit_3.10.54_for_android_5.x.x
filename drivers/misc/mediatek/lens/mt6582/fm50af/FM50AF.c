...
static struct i2c_board_info kd_lens_dev __initdata = { I2C_BOARD_INFO("FM50AF", 0x18) };
...
#define FM50AF_DEBUG
#ifdef FM50AF_DEBUG
#define FM50AFDB printk //[LGE_UPDATE][yonghwan.lym@lge.com][2014-12-16] af kernel log enable
#else
#define FM50AFDB(x, ...)
#endif
...
static struct i2c_client *g_pstFM50AF_I2Cclient;

static dev_t g_FM50AF_devno;
static struct cdev *g_pFM50AF_CharDrv;
static struct class *actuator_class;

static int g_s4FM50AF_Opened;
static long g_i4MotorStatus;
static long g_i4Dir;
static unsigned long g_u4FM50AF_INF;
...
/* ////////////////////////////////////////////////////////////// */
static long FM50AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
