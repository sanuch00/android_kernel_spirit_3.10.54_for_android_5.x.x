...
#if defined(CONFIG_LGE_TPA2028D)
#include "tpa2028d.h"
#endif
#ifdef CONFIG_LGE_TPA_REV
...
static int AudDrv_probe(struct platform_device *dev)
{
    ...
    PRINTK_AUDDRV("-AudDrv_probe \n");
#if defined(CONFIG_LGE_TPA2028D)
    #if defined(CONFIG_LGE_TPA_REV)
	if(board_rev == REV)
	    Speaker_Init();
	else
            Speaker_Init_tpa2028d();
    #else
	Speaker_Init_tpa2028d();
    #endif
#else
	...
	case GET_EAMP_PARAMETER:
	{
		...
		if(board_rev == REV){
			...
			switch(AMPParam.command)
			{
				case AUD_AMP_GET_REGISTER:
				{
					ret = Audio_eamp_command_tpa2028d(EAMP_GETREGISTER_VALUE,AMPParam.param1,1);
					break;
				}
				case AUD_AMP_GET_CTRP_NUM:
				{
					ret = Audio_eamp_command_tpa2028d(EAMP_GET_CTRP_NUM,AMPParam.param1,1);
					break;
				}
				case AUD_AMP_GET_CTRP_BITS:
				{
					ret = Audio_eamp_command_tpa2028d(EAMP_GET_CTRP_BITS,AMPParam.param1,1);
					break;
				}
				case AUD_AMP_GET_CTRP_TABLE:
				{
					Audio_eamp_command_tpa2028d(EAMP_GET_CTRP_TABLE,(unsigned long)&AMPParam,1);
					break;
				}
				case AUD_AMP_GET_AMPGAIN:
				{
					ret = Audio_eamp_command_tpa2028d(EAMP_GETAMP_GAIN,0,1);
					break;
				}
				default:
					break;
	...
	case SET_EAMP_PARAMETER:
	{
		...
		if(board_rev == REV){
			...
			switch(AMPParam.command)
			{
				case AUD_AMP_SET_AMPGAIN:
				{
					Audio_eamp_command_tpa2028d(EAMP_SETAMP_GAIN,AMPParam.param1,1);
					break;
				}
				case AUD_AMP_SET_REGISTER:
				{
					Audio_eamp_command_tpa2028d(EAMP_SETREGISTER_VALUE,(unsigned long)&AMPParam,1);
					break;
				}
				case AUD_AMP_SET_MODE:
				{
					Audio_eamp_command_tpa2028d(EAMP_SETMODE,AMPParam.param1,1);
					break;
				}
// 2014-06-27 hyeonsang85.park@lge.com : let tpa2028d know current device for combo_path gain control - start
				case AUD_AMP_SET_DEVICE:
				{
					Audio_eamp_command_tpa2028d(EAMP_SETDEVICE,AMPParam.param1,1);
					break;
				}
// 2014-06-27 hyeonsang85.park@lge.com : let tpa2028d know current device for combo_path gain control - end
				default:
					break;
			}
		}
...
// 2014-06-27 hyeonsang85.park@lge.com : let tpa2028d know current device for combo_path gain control - end
	...
	if(board_rev == REV)
		...
		Audio_eamp_command_tpa2028d(EAMP_SPEAKER_OPEN,(int)arg,1);
    #else
	Audio_eamp_command_tpa2028d(EAMP_SPEAKER_OPEN,(int)arg,1);
    #endif
#else
	...
	if(board_rev == REV)
		...
		Audio_eamp_command_tpa2028d(EAMP_SPEAKER_CLOSE,(int)arg,1);
    #else
		Audio_eamp_command_tpa2028d(EAMP_SPEAKER_CLOSE,(int)arg,1);
    #endif
#else
		...
		if(board_rev == REV)
			...
			Audio_eamp_command_tpa2028d(EAMP_HEADPHONE_OPEN, arg, 1);
    #else
		Audio_eamp_command_tpa2028d(EAMP_HEADPHONE_OPEN, arg, 1);
    #endif
#else
		...
		if(board_rev == REV)
			...
			Audio_eamp_command_tpa2028d(EAMP_HEADPHONE_CLOSE, arg, 1);
    #else
		Audio_eamp_command_tpa2028d(EAMP_HEADPHONE_CLOSE, arg, 1);
#endif
#else
		...
		if(board_rev == REV)
			...
			Audio_eamp_command_tpa2028d(EAMP_EARPIECE_OPEN, arg, 1);
    #else
		Audio_eamp_command_tpa2028d(EAMP_EARPIECE_OPEN, arg, 1);
    #endif
#else
		...
		if(board_rev == REV)
			...
			Audio_eamp_command_tpa2028d(EAMP_EARPIECE_CLOSE, arg, 1);
    #else
		Audio_eamp_command_tpa2028d(EAMP_EARPIECE_CLOSE, arg, 1);
    #endif
#else
