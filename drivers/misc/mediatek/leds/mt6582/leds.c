...
#if defined(TARGET_MT6582_Y50)  /* LGE_BSP_COMMON LGE_CHANGE_S 140303 jongwoo82.lee : interface for HW tunning */
extern int chargepump_backlight_level_test(int);
...
#if defined(TARGET_MT6582_Y90) || defined(TARGET_MT6582_Y70) \
|| defined(TARGET_MT6582_B2L) || defined(TARGET_MT6582_P1S3G) /* LGE_BSP_COMMON sangcheol.seo@lge.com 140520 : LED */
typedef struct {
...
#else
static ISINK1_LED_Breathmode_set_table led_scene_setting[] = {
	{0x00, 31, 999, 15, 3, 0},// 0.charging
	{0x00, 31, 999,  7, 3, 0},// 1.Power on
	{0x00, 31, 999,  7, 3, 0},// 2.Power off
	{0x00, 31, 999,  0, 0, 0},// 3.Alarm
	{0x00, 31, 999,  2, 0, 0},// 4.Incomming call
	{0x00, 31, 999,  0, 0, 0},// 5.Urgent Incomming call
	{0x00, 31, 999,  4, 3, 2},// 6.In call
	{0x00, 31, 999,  0, 4, 0},// 7.Knock_on / Knock_code_fail / Bluetooth connect / Bluetooth disconnect
	{0x00, 31, 999,  0, 0, 4},// 8.Missed call / Urgent missed call
	{0x00, 31, 999,  7, 3, 0},// 9.default
};
#endif
