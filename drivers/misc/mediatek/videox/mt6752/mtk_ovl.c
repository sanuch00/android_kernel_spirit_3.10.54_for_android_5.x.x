...
int ovl2mem_get_info(void *info)
{
    ...
    /* LGE_CHANGE_S: [2014-11-24] lewis.lee@lge.com */
    /* Comment: Now HWCompsoer HAL returns actucal DPI based on physical
                display size. And 'One hand operation' menu is appeared
                in the Settings.*/
#if 0
...
#endif
    /* LGE_CHANGE_E: [2014-11-24] lewis.lee@lge.com */
