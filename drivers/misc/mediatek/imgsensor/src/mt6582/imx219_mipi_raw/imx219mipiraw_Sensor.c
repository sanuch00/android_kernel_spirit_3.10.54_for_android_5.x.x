...
static kal_uint16 IMX219MIPIReg2Gain(const kal_uint8 iReg)
{
    ...
    //[LGE_UPDATE_S][youmi.jun@lge.com][2014-06-24] WBT_ISSUE
    if(iI == 0)
        iI = 1;
    //[LGE_UPDATE_E][youmi.jun@lge.com][2014-06-24] WBT_ISSUE
...
static kal_uint8 IMX219MIPIGain2Reg(const kal_uint16 iGain)
{
    ...
    for (iI = 0; iI < (IMX219MIPI_MaxGainIndex-1); iI++)
    {
        ...
        if(iGain == IMX219MIPI_sensorGainMapping[iI][0]) //[LGE_UPDATE_S][youmi.jun@lge.com][2014-06-24] Bug fix "<" -> "=="
        {
...
void VideoFullSizeSetting(void)//16:9   6M
{
    ...
    IMX219MIPI_write_cmos_sensor(0x0172, 0x03); // [LGE_UPDATE] [kipo.yun@lge.com] [2014-05-12] Orientation Modify
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->CaptureDelayFrame = 1; //[LGE_UPDATE][yonghwan.lym@lge.com][2014-06-27] Flash Timing Tuning
