...
UINT32 OV8858S_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //[LGE_UPDATE][yonghwan.lym@lge.com][2015-01-02] Multiple EEPROM Suport
UINT32 OV5670_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); // LGE_CHANGE: [2014-11-24] yonghwan.lym@lge.com, Add camera(OV5670)
...
UINT32 S5K3L2XX_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);  // LGE_CHANGE: [2014-12-08] youmi.jun@lge.com, Add Camera
...
//! 3. Add by the sensor from "ProjectConfig.mk and defconfig" //LGE_CHANGE: [2015-01-02] yonghwan.lym@lge.com
ACDK_KD_SENSOR_INIT_FUNCTION_STRUCT kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR+1] =
{
// LGE_CHANGE_S: [2014-12-08] youmi.jun@lge.com, Add camera
#if defined(S5K3L2XX_MIPI_RAW)
   {S5K3L2XX_SENSOR_ID, SENSOR_DRVNAME_S5K3L2XX_MIPI_RAW, S5K3L2XX_MIPI_RAW_SensorInit},
#endif
// LGE_CHANGE_E: [2014-12-08] youmi.jun@lge.com, Add camera
...
#endif
// LGE_CHANGE_S: [2014-11-24] yonghwan.lym@lge.com, Add camera(OV5670)
#if defined(OV5670_MIPI_RAW)
    {OV5670_SENSOR_ID, SENSOR_DRVNAME_OV5670_MIPI_RAW, OV5670_MIPI_RAW_SensorInit},
#endif
// LGE_CHANGE_E: [2014-11-24] yonghwan.lym@lge.com, Add camera(OV5670)
