...
//LGE_CHANGE_S: [2014-12-31] kyunghun.oh@lge.com, Enable ExposureTime
UINT16 ExposureTime_High;
UINT16 ExposureTime_Mid;
UINT16 ExposureTime_Low;
UINT16 ExposureTime = 0;
UINT16 ISO_RegVal = 0;
//LGE_CHANGE_E: [2014-12-31] kyunghun.oh@lge.com, Enable ExposureTime
...
{
    kal_uint32 len=0;
    kal_bool prv_night_mode; //[LGE_UPDATE][youmi.jun@lge.com][2014-04-18] Add night_mode control
    ...
    spin_lock(&hi707_yuv_drv_lock);
    prv_night_mode = HI707_sensor.night_mode; //[LGE_UPDATE][youmi.jun@lge.com][2014-04-18] Add night_mode control
    ...
    else if (prv_night_mode) //[LGE_UPDATE][youmi.jun@lge.com][2014-04-18] Add night_mode control
    {
        #ifdef MTK_ORIGINAL_CODE
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
 ...
 //   pSensorInfo->SensorFullResolutionY=HI707_IMAGE_SENSOR_FULL_HEIGHT;
    ...
    pSensorInfo->PreviewDelayFrame = 1;//4;//10; //[LGE_UPDATE][yonghwan.lym@lge.com][2014-04-16] Preview skip frame change to reduce the entry time
...
// LGE_CHANGE_S: [2014-12-04] kyunghun.oh@lge.com, Enable touch AE
    else{
		#if 1
			HI707_write_cmos_sensor(0x03,0x10);
			HI707_write_cmos_sensor(0x12,HI707_read_cmos_sensor(0x12)|0x10);
		...
		// LGE_CHANGE_E: [2014-12-04] kyunghun.oh@lge.com, Enable touch AE
		#else
                switch (para)
                {
                case AE_EV_COMP_20: //+2 EV
...
{
    *pFeatureReturnPara32 = 1;// LGE_CHANGE: [2014-12-04] kyunghun.oh@lge.com, Enable touch AE
...
void HI707GetExifInfo(UINT32 exifAddr)
{
    ...
    pExifInfo->CapExposureTime = (ExposureTime*4);////LGE_CHANGE: [2014-12-31] kyunghun.oh@lge.com, Enable ExposureTime and isoSpeed
                             ...
                             UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
        ...
        *pFeatureParaLen=4;
		...
		//[LGE_UPDATE_S][kyunghun.oh@lge.com][2014-12-24] Get FOV from sensor for CTS
         ...
         //[LGE_UPDATE_E][kyunghun.oh@lge.com][2014-12-24] Get FOV from sensor for CTS
    default:
        break;
    }
    return ERROR_NONE;
