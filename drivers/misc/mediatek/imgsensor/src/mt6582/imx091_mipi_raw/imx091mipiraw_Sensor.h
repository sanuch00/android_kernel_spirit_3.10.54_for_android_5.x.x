...
#define IMX091MIPI_COLOR_FORMAT                    SENSOR_OUTPUT_FORMAT_RAW_R //[LGE_UPDATE] [kipo.yun@lge.com] [2014-05-12] Orientation Modify SENSOR_OUTPUT_FORMAT_RAW_B-->SENSOR_OUTPUT_FORMAT_RAW_R
