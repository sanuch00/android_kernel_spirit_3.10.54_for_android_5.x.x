...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .grabwindow_width = 1624,        //record different mode's width of grabwindow
        .grabwindow_height = 1216,        //record different mode's height of grabwindow
    ...
    .normal_video = {
        ...
        .startx = 0,
        .starty = 0,
        .grabwindow_width = 2172,
        .grabwindow_height = 1220,
        .mipi_data_lp2hs_settle_dc = 14,
        .max_framerate = 300,
    },
     .hs_video = {
...
//LGE_UPDATE_S [youmi.jun@lge.com] 2014/11/18, Apply ZSD patch
...
//LGE_UPDATE_E [youmi.jun@lge.com] 2014/11/18, Apply ZSD patch
...
write_cmos_sensor(0x0344, 0x00); // x_addr_start_Hi
write_cmos_sensor(0x0345, 0x24); // x_addr_start_Lo (40, Display시에 20-23 은 잘리고 24 부터 출력)
write_cmos_sensor(0x0346, 0x00); // y_addr_start_Hi
write_cmos_sensor(0x0347, 0x28); // y_addr_start_Lo (40, Display시에 22-23 은 잘리고 24 부터 출력)
write_cmos_sensor(0x0348, 0x0C); // x_addr_end_Hi
write_cmos_sensor(0x0349, 0xE3); // x_addr_end_Lo (3303, Display시에 3320-3323 은 잘림)
write_cmos_sensor(0x034A, 0x09); // y_addr_end_Hi
write_cmos_sensor(0x034B, 0xB7); // y_addr_end_Lo (2487, Display시에 2504-2505 은 잘림)
...
write_cmos_sensor(0x0804, 0x1F);  // tclk_trail_min 70ns
write_cmos_sensor(0x0805, 0x17);  // tclk_prepare 64ns
write_cmos_sensor(0x0806, 0x00);  // tclk prepare + tclk_zero 406ns
write_cmos_sensor(0x0807, 0x1F);  // tlpx 84ns
                     // clk pre 90ns
...
write_cmos_sensor(0x0340, 0x04);  //    frame_length_lines_Hi
write_cmos_sensor(0x0341, 0xE8);  //    frame_length_lines_Lo
write_cmos_sensor(0x034C, 0x08);  //    X_output_size_Hi (1632)
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_IHDR_SHUTTER_GAIN:
            ...
            break;
        //[LGE_UPDATE_S][youmi.jun@lge.com][2015-1-5] add FOV value
        ...
        //[LGE_UPDATE_E][youmi.jun@lge.com][2015-1-5] add FOV value
        default:
            break;
    }
