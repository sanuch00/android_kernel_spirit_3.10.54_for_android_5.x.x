...
UINT32 HI841_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);	// LGE_CHANGE: [2014-10-01] youmi.jun@lge.com, Add camera
UINT32 OV2680MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 IMX132_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);	// LGE_CHANGE: [2014-10-01] youmi.jun@lge.com, Add camera
...
{
// LGE_CHANGE_S: [2015-01-08] youmi.jun@lge.com, Add camera
#if defined(HI841_MIPI_RAW)
    {HI841_SENSOR_ID, SENSOR_DRVNAME_HI841_MIPI_RAW,HI841_MIPI_RAW_SensorInit},  // 8MP
#endif
#if defined(OV5670_MIPI_RAW)
    {OV5670MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5670_MIPI_RAW, OV5670_MIPI_RAW_SensorInit},   // 5MP
#endif
// LGE_CHANGE_E: [2015-01-08] youmi.jun@lge.com, Add camera
  ...
  {AR0833_SENSOR_ID, SENSOR_DRVNAME_AR0833_MIPI_RAW,AR0833_MIPI_RAW_SensorInit},
    ...
    {IMX132_SENSOR_ID, SENSOR_DRVNAME_IMX132_MIPI_RAW, IMX132_MIPI_RAW_SensorInit},
#endif
