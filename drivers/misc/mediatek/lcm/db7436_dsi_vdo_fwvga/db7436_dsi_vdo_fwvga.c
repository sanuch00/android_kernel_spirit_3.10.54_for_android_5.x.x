...
#if 0  /* LGE_BSP_COMMON LGE_CHANGE_S 141105 jongwoo82.lee : init code tunning */
...
#endif
#endif  /* LGE_BSP_COMMON LGE_CHANGE_E 141105 jongwoo82.lee : init code tunning */
...
#if (!defined(BUILD_UBOOT) && !defined(BUILD_LK))  && defined(INIT_CODE_TUNNING_BY_SD_CARD)  /* LGE_BSP_COMMON LGE_CHANGE_S 141105 jongwoo82.lee : init code tunning */
...
#if 1 // LGE_CHAGNE_S sangcheol.seo@lge.com 130524 ,
...
#if 1  /* LGE_BSP_COMMON LGE_CHANGE_S 141221 jongwoo82.lee :  */
        dsi_set_cmdq(data_array, 1, 1);  // add sleep in cmd one more for not sending case
#endif  /* LGE_BSP_COMMON LGE_CHANGE_E 141221 jongwoo82.lee :  */
...
//		.pwm_no = PWM1, // Rev A
  ...
  #if defined(TARGET_MT6582_Y50)  /* LGE_BSP_COMMON LGE_CHANGE_S 141119 jongwoo82.lee : PWM fps change for LCD/Touch Timing */
...
#endif  /* LGE_BSP_COMMON LGE_CHANGE_E 141119 jongwoo82.lee : PWM fps change for LCD/Touch Timing */               
};
...
static void lcm_set_pwm_for_mix(int enable)
{
    ...
    if (enable)
    {
#if defined(TARGET_MT6582_Y50)  /* LGE_BSP_COMMON LGE_CHANGE_S 141226 jongwoo82.lee : do not calculate the width */
        //lcm_set_fps(params.dsi.pwm_fps);
#else
        lcm_set_fps(params.dsi.pwm_fps);
#endif  /* LGE_BSP_COMMON LGE_CHANGE_E 141226 jongwoo82.lee : do not calculate the width */
