...
/* LGE_CHANGE_S: [2014-10-10] sungmin.ho@lge.com */
...
/* LGE_CHANGE_E: [2014-10-10] sungmin.ho@lge.com */
...
/*sangchul1.park@lge.com add cdrom stroage mode*/
...
static struct android_usb_function *supported_functions[] = {
	...
	&accessory_function,
#ifdef CONFIG_USB_G_LGE_ANDROID_AUTORUN
    &cdrom_storage_function, /*sangchul1.park@lge.com add cdrom stroage mode*/
#endif
...
//			musb->softconnect = 1;
	...
	//LGE_CHANGE_E jingyu.an 2014.02.28
#endif
	/* Added for USB Develpment debug, more log for more debuging help */
...
//LGE_CHANGE_S namgyu.kim 2014.02.10 for debugging mini OS  after loading adb driver
...
#endif
/* LGE_CHANGE_S :fatory cable detection. sangchul1.park@lge.com */
#ifdef CONFIG_USB_G_LGE_ANDROID
	android_set_factory_mode(cdev);
#endif
/* LGE_CHANGE_E :fatory cable detection.*/
	return 0;
}
