...
#define _YUSU_ANDROID_SPEAKER_H_
  ...
  enum EAMP_CONTROL_SUBCOMMAND
 {
	 ...
	 EAMP_GET_CTRP_TABLE,
	 EAMP_SETMODE,
	 EAMP_SETDEVICE // 20140627 let tpa2028d know current device for combo_path gain control - hyeonsang85.park@lge.com
 };
...
enum AUDIO_AMP_CONTROL_COMMAND{
    ...
    AUD_AMP_GET_AMPGAIN,
    AUD_AMP_SET_MODE,
    AUD_AMP_SET_DEVICE, // 20140627 let tpa2028d know current device for combo_path gain control - hyeonsang85.park@lge.com
    NUM_AUD_AMP_COMMAND
};
