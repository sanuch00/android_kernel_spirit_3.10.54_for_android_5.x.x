...
/* LGE_CHANGE_S: LGP-S18 inmok.kim@lge.com [2014-2-24] : modified register value */
#if defined(CONFIG_LGE_PM)
#define R_CHARGER_2 51
#else
...
#define CUST_R_SENSE         68
#elif defined(CONFIG_MTK_EXTERNAL_CHARGER_SUPPORT)
#define CUST_R_SENSE         68
#else
...
#define SOC_RESCALING_FACTOR 97
#endif
